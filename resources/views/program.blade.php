...
<section class="py-12 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {{-- SECTION 3: GRID KATALOG PROGRAM DONASI BANYAK CARD --}}
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8" id="kampanye-grid">
            @foreach($daftar_kampanye as $item)
                ...
                <div class="p-6 flex-1 flex flex-col justify-between space-y-4">
                    <div class="space-y-2">
                        <div class="flex items-center justify-between text-[10px] font-bold text-slate-400">
                            ...
                            <span class="flex items-center gap-1 text-slate-500">{{ $item['lokasi'] }}</span>
                        </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="flex justify-between text-xs font-semibold text-slate-500">
                            ...
                            <span class="text-emerald-700 font-bold">{{ $item['persen'] }}</span>
                        </div>
                    </div>
