        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl overflow-hidden border border-slate-200/60 shadow-sm hover:shadow-lg transition flex flex-col">
                    <img src="{{ $item->img }}" alt="Gambar Program" class="h-48 w-full object-cover">
                    <div class="p-6 flex-1 flex flex-col justify-between space-y-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="flex justify-between text-xs font-semibold text-slate-500">
                                <span>Terkumpul: <strong class="text-slate-800">{{ $item->terkumpul }}</strong></span>
                                <span class="text-emerald-700">{{ $item->persen }}</span>
                            </div>
                        </div>
                        ...
                        <div class="pt-2 border-t border-slate-100 flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm font-bold text-slate-700">{{ $item->target }}</p>
                            </div>
                            <a href="{{ Route::has('donasi.create') ? route('donasi.create') : '#' }}" class="bg-emerald-800 hover:bg-emerald-700 text-white px-4 py-2 rounded-xl text-xs font-bold transition shadow-sm">Donasi</a>
                        </div>
                    </div>
                </div>
                @endforeach
